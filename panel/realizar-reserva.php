                            ...
                            <div class="p-5">
                                ...
                                <form action="controlador/guardarReserva.php" method="POST">
                                    <div class="form-group row">
                                        ...
                                        if($cantidad > 0){?>
                                            <label style="color: green;">Mesa: Disponible</label>
                                        <?php } else  { ?>
                                            <label style="color: red;">Mesa: No Disponible</label>
                                            <?php }?>
                                        </div>
                                        <div class="col-sm-8">
                                            <label>N° Personas x Mesa: 4 Personas - 1 Mesa</label>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            <input type="number" class="form-control" id="cantidad" name="cantidad" placeholder="N° Personas">
                                        </div>
                                        <div class="col-sm-4">
