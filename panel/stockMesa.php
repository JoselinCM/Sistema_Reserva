                                        ...
                                        ?>
                                            <div class="form-group row" >
                                                <div class="col-sm-3">
                                                    ...
                                                    <input type="number" name="cantidad" value="<?php echo $row['cantidad']; ?>" class="form-control form-control-user" id="exampleLastName">
                                                </div>
                                                <div class="col-sm-3">
                                                <br>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Grupo 5  2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
